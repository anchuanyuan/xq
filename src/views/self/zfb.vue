<template>
  <div class="container" style="background-color: #000000; height: 100vh;">
    <Header isback title="绑定支付宝账号"></Header>
    <div class="box">
      <div class="title">账户名称</div>
      <div class="name">
          <!-- readonly 只读状态 为true时不可编辑  反之可编辑 -->
          <input type="text" v-model="accountName" :readonly="state" placeholder="账户名和实名信息一致(真实姓名)">
      </div>
    </div>
    <div class="box">
      <div class="title">支付宝手机号</div>
      <div class="name">
          <input type="text" v-model="account" :readonly="state" placeholder="请输入支付宝账号">
      </div>
    </div>
    <div class="box1">
